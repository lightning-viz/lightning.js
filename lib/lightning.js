...
Lightning.prototype.plot = function(type, data, images) {
    var self = this;
        ...
        .then(function() {
            ...
            if(images) {
                ...
                return rp(opts).then(function(response) {
                    ...
                    return new Visualization(self, response.id);
                }).then(function(viz) {
...
_.extend(Lightning.prototype, _.object(_.keys(types), _.map(types, function(f, type) {
    return function() {
        ...
        return this.plot(paramCase(type), output.data, output.images, output.options);
    };
})));
